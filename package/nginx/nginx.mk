...
NGINX_CONF_OPTS += \
	...
	--lock-path=/data/run/lock/nginx.lock \
	--user=root \
	--group=root \
	--error-log-path=/data/log/nginx/error.log \
	--http-log-path=/data/log/nginx/access.log \
	--http-client-body-temp-path=/data/tmp/nginx/client-body \
	--http-proxy-temp-path=/data/tmp/nginx/proxy \
	--http-fastcgi-temp-path=/data/tmp/nginx/fastcgi \
	--http-scgi-temp-path=/data/tmp/nginx/scgi \
	--http-uwsgi-temp-path=/data/tmp/nginx/uwsgi
